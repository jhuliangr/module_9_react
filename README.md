...
| Main Menu                                                                                    | In Game                                                                                    |
| -------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------ |
| ![Main menu](https://res.cloudinary.com/dfoqeafey/image/upload/v1779111724/main_menu.png) | ![In Game](https://res.cloudinary.com/dfoqeafey/image/upload/v1776708779/react-game-2.png) |
